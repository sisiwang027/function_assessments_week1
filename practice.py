...
def sign_and_parity(input_integer):
    if input_integer == 0:
        sign = "Zero"
        parity = "Even"
    elif input_integer > 0:
...
number = 8
is_sign, is_parity = sign_and_parity(number)
print "The {} is {}, {}.".format(number, is_sign, is_parity)
